...
`
  ...
  order.forEach(groupName => {
    ...
    group.sheets.forEach(sheet => {
      ...
      content += `[<img src="png/${j}.png" width="288">](png/${j}.png)

<details>
  <summary><strong>PNG 72px sheets</strong></summary>

  <p>
  Sheet image: <a href="png/${j}.png">${j}.png</a> ~ ${sizes.png.png} kB<br>
  CSS sprite sheet: <a href="png/${j}.css">${j}.css</a> ~ ${sizes.png.css} kB<br>
  Custom JSON: <a href="png/${j}.json">${j}.json</a><br>
  Hexcodes JS: <a href="png/${j}-hexcodes.js">${j}-hexcodes.js</a>
  </p>

  <h6>Usage examples for PNG sheets</h6>
  <p>
  HTML image map: <a href="png/${j}.html">${j}.html</a><br>
  CSS sprites: <a href="png/${j}-css.html">${j}-css.html</a>
  </p>
</details>
